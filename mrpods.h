...
static_assert(sizeof(t_data) == 128, "Invalid data alignment");
...
static_assert(sizeof(t_superdata) == sizeof(t_data), "Invalid data alignment");
...
typedef struct t_printdata {           // Print control structure
  ...
  char           infile[MAX_PATH];      // Name of input file
  char           outbmp[MAX_PATH];      // Name of output bitmap (empty: paper)
...
unique char      infile[MAX_PATH];      // Last selected file to read
unique char      outbmp[MAX_PATH];      // Last selected bitmap to save
unique char      inbmp[MAX_PATH];       // Last selected bitmap to read
unique char      outfile[MAX_PATH];     // Last selected data file to save
